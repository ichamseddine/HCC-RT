...
pathsave = 'stratification_internal'
try:
    os.mkdir(pathsave)
except FileExistsError:
    pass
    
pathsave = f'stratification_internal/{estname}'
try:
    os.mkdir(pathsave)
except FileExistsError:
    pass
...
group = pd.qcut(df1['risk'], q=2, labels=False)
...
group = pd.qcut(df1['risk'], q=4, labels=False)
df2 = df1.copy()
...
df4 = pd.read_excel("../dataset.xlsx")
